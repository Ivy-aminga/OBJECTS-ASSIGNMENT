...
function objectProducts(products) {
  let groupedProducts = {};
...
let groupedProducts = objectProducts(products);
...
function objectScores(students, average) {
...
console.log(objectScores(students,85))
